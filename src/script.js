...
import fragmentGalaxyShader from './shaders/galaxy/fragment.glsl';
import vertexGalaxyShader from './shaders/galaxy/vertex.glsl'
...
const generateGalaxy = () =>
{
    ...
    material = new THREE.ShaderMaterial({
        ...
        vertexColors: true,
        vertexShader: vertexGalaxyShader,
        fragmentShader: fragmentGalaxyShader,
        uniforms: {
            uTime: { value: 0 },
